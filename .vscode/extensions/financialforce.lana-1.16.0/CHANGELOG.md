...
- Fix issue [#7](https://github.com/certinia/debug-log-analyzer/issues/7) Command 'lana.showLogFile' not found
- Fix issue [#3](https://github.com/certinia/debug-log-analyzer/issues/3) Cannot read property 'path' of undefined

## [1.3.4] - December 2020

- Fix issue [#4](https://github.com/certinia/debug-log-analyzer/issues/4) with Windows paths
